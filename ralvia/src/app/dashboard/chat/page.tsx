...
export default function FinanceChat() {
  ...
  return (
    <div className="relative flex h-[80vh] min-h-[480px] overflow-hidden rounded-md border border-[#D8DCE3] bg-white sm:h-[650px]">
      {/* HISTORY SIDEBAR */}
      <div
        className={`absolute inset-y-0 left-0 z-20 flex w-64 max-w-[80%] flex-col border-r border-[#D8DCE3] bg-[#FBFAF8] transition-transform duration-200 sm:static sm:z-auto sm:max-w-none sm:translate-x-0 ${
          historyOpen
            ? "translate-x-0"
            : "-translate-x-full"
        }`}
      >
        <div className="flex items-center gap-2 p-3">
          <button
            ...
            className="flex-1 rounded-md bg-[#14213D] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#1c2d52]"
          >
            + New chat
          </button>
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md text-[#5B6472] transition-colors hover:bg-[#14213D]/5 hover:text-[#14213D] sm:hidden"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
      ...
      {historyOpen && (
        <button
          ...
          className="absolute inset-0 z-10 bg-[#14213D]/30 sm:hidden"
        />
      )}
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        {/* TOP BAR */}
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-[#D8DCE3] p-3 sm:p-4">
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-[#D8DCE3] text-[#5B6472] transition-colors hover:text-[#14213D] sm:hidden"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
            ...
            <div>
              <p className="font-serif text-base text-[#14213D] sm:text-lg">
                        ...
                        >
                          ...
                          <div className="mt-3 space-y-2 text-sm text-[#14213D]">
                            ...
                            <p>
                              ...
                              $
                              {message.action.data.amount.toLocaleString()}
                            </p>
        ...
        <form
          ...
          className="border-t border-[#D8DCE3] p-3 sm:p-4"
        >
          {error && (
          ...
          <div className="flex flex-wrap gap-2 sm:flex-nowrap sm:gap-3">
            <input
              ...
              className="order-1 w-full min-w-0 flex-1 rounded-md border border-[#D8DCE3] px-4 py-3 text-sm text-[#14213D] outline-none transition-colors focus:border-[#14213D] sm:w-auto"
            />
            ...
            <button
              ...
              className={`order-2 shrink-0 rounded-md border px-4 py-3 text-sm font-medium transition-colors disabled:opacity-50 ${
                listening
            ...
            {speaking && (
              <button
                ...
                className="order-3 shrink-0 rounded-md border border-[#D8DCE3] px-4 py-3 text-sm font-medium text-[#5B6472] transition-colors hover:text-[#14213D]"
              >
                🔇 Stop
              </button>
            )}
            ...
            <button
              ...
              className="order-4 shrink-0 rounded-md bg-[#14213D] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-[#1c2d52] disabled:opacity-50"
            >
              Send
            </button>
          </div>
